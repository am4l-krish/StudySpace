  ...
  return (
    <div className="ai-page" style={{ padding: '20px', height: 'calc(100vh - 40px)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        border: '1px solid #2a1f6e', borderRadius: '12px', padding: '16px',
        ...
        {messages.map((msg, i) => (
          <div key={i} style={{ display: 'flex', justifyContent: msg.role === 'user' ? 'flex-end' : 'flex-start' }}>
            <div style={{
              ...
              background: msg.role === 'user' ? 'linear-gradient(135deg, #5b21b6, #7c3aed)' : 'rgba(124,58,237,0.08)',
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        <input type="text" placeholder="Ask your academic question..."

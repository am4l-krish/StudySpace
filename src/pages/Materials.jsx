...
function Materials() {
  ...
  const addMaterial = () => {
    ...
    setMaterials([...materials, { id: Date.now(), title, link, type }])
    setTitle('')
    setLink('')
    setType('Notes')
  }

  const deleteMaterial = (id) => setMaterials(materials.filter(m => m.id !== id))
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          ...
          <select
            ...
            style={{ ...inputStyle, background: '#0a0a18', color: '#a78bfa' }}
          >
            ...
            <div key={m.id} style={{
              ...
              {m.type === 'PDF' && (
                <div style={{
                  ...
                  padding: '20px', textAlign: 'center', fontSize: '32px'
                }}>📄</div>
              )}
